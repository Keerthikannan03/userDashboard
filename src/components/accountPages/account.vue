...
<template>
  <div>
    ...
    <div class="d-flex justify-content-between ga-2 w-25">
      ...
      <v-btn @click="store.increment()" color="#1976d2" :disabled="store.doubleCount >= 10"><v-icon>mdi-plus</v-icon></v-btn>
    ...
    <div class="d-flex justify-content-between ga-2 w-25">
      ...
      <v-btn @click="store.startCount()" color="#1976d2" :disabled="store.doubleCount >= 10">Start</v-btn>
      <v-btn @click="resetStore()" color="danger">Reset</v-btn>
